...
Dewey takes your privacy very seriously. We believe your reading history, private notes, and library are personal and should remain private.

## Data Collection

**Dewey does not collect personal reading data.**
...
Dewey uses the Google Books API for book lookup. When you search by title, author, or ISBN, or scan a barcode, that lookup request is sent to Google so matching book metadata can be returned. Your saved library, reading sessions, and private notes are not sent to Google by Dewey.

If iCloud sync is enabled, Apple handles syncing your library through your personal iCloud account. We do not have access to your iCloud data.
...
If you have any questions about this Privacy Policy, please contact us at [hello@lachlaneagling.com](mailto:hello@lachlaneagling.com).
